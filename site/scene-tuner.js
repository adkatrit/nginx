...
window.SceneTuner = (function() {
  ...
  const defaultParams = {
    ...
    ocean: {
      waveHeight:  { value: 1.6, min: 0,   max: 5,   step: 0.05, label: 'Wave Shading' },
      waveScale:   { value: 1.0, min: 0.3, max: 3.0, step: 0.05, label: 'Wave Scale' },
      foamStart:   { value: 3.0, min: 0,   max: 6,   step: 0.05, label: 'Foam Start' },
      foamEnd:     { value: 4.2, min: 0,   max: 7,   step: 0.05, label: 'Foam End' },
      foamAmount:  { value: 0.5, min: 0,   max: 1,   step: 0.05, label: 'Foam Amount' },
      glint:       { value: 1.0, min: 0,   max: 5,   step: 0.1,  label: 'Glint' },
      glintTight:  { value: 90,  min: 8,   max: 320, step: 4,    label: 'Glint Tightness' },
      detail:      { value: 0.9, min: 0,   max: 3,   step: 0.05, label: 'Detail (random)' },
      detailScale: { value: 0.04, min: 0.005, max: 0.15, step: 0.005, label: 'Detail Scale' },
    },
    terrain: {
