...
window.SceneTuner = (function() {
  ...
  const defaultParams = {
    ...
    ocean: {
      waveHeight:  { value: 1.1, min: 0,   max: 5,   step: 0.05, label: 'Wave Shading' },
      waveScale:   { value: 0.95, min: 0.3, max: 3.0, step: 0.05, label: 'Wave Scale' },
      foamStart:   { value: 0.35, min: 0,  max: 6,   step: 0.05, label: 'Foam Start' },
      foamEnd:     { value: 1.05, min: 0,  max: 7,   step: 0.05, label: 'Foam End' },
      foamAmount:  { value: 0.0, min: 0,   max: 1,   step: 0.05, label: 'Foam Amount' },
      glint:       { value: 1.0, min: 0,   max: 5,   step: 0.1,  label: 'Glint' },
      glintTight:  { value: 128, min: 8,   max: 320, step: 4,    label: 'Glint Tightness' },
      detail:      { value: 2.15, min: 0,  max: 3,   step: 0.05, label: 'Detail (random)' },
      detailScale: { value: 0.05, min: 0.005, max: 0.15, step: 0.005, label: 'Detail Scale' },
    },
    terrain: {
